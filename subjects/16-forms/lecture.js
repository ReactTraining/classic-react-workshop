...
////////////////////////////////////////////////////////////////////////////////
// Some forms are transactional, so modeling in state isn't
// necessary, just use dom APIs to access the data, like when
// you need to save off some data somewhere and reset the form,
// but the values in the form are never important to `render`
//const Forms = React.createClass({
  //handleSubmit(event) {
...
////////////////////////////////////////////////////////////////////////////////
// if we did want it all in state, we don't have to link
// up every single element to state, can use form onChange.
// updates won't be synchronized when other parts of the app
