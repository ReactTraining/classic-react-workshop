...
class Tone extends React.Component {
  // Called once, immediately after the initial mount into the DOM.
  componentDidMount() {
    this.oscillator = createOscillator();
    this.doImperativeWork();
  }

  // Called after the DOM is updated, not on the first render.
  componentDidUpdate() {
    this.doImperativeWork();
  }

  // DEPRECATED in 16.3, the new method is static getDerivedStateFromProps
  componentWillReceiveProps(nextProps) {
    // The only thing you should do in here is
    // setState in response to prop changes.
  }
